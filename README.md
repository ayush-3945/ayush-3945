...
Domain: Full-Stack Engineering & AI Systems
Specialization: 
  - Scalable Node.js / Express Microservices
  - React 19 Client Architectures
  - Document Extraction & Vector AI Workflows

Highlights:
  - CodeChef 3-Star (400+ DSA Problems Solved)
  - Former PR Head @ CodeChef Student Chapter
  - IBM Enterprise Virtual Internship Alum

Philosophy:
  "Clean code, measurable system performance, 
   and zero compromise on UX."
```
...
### ⛏️ CoalDarpan — Mining Safety & Compliance
*Enterprise AI platform built for underground coal mining safety and DGMS compliance.*

- ⚡ **Key Engineering:** Zero-network offline PWA sync, GPS pit geofencing (Haversine algorithm), and Gemini 1.5 automated emergency SOP triage.
- 🛠️ **Stack:** React.js • Node.js • Socket.io • Gemini AI • MongoDB
...
<a href="https://coaldarpan.vercel.app">
...
### 🤖 AI Interview Agent — Mock Prep Platform
*Real-time AI voice technical interviewer simulating role-specific technical rounds.*

- ⚡ **Key Engineering:** Low-latency Web Speech API integration, multi-turn conversational memory, and automated interview report generation.
- 🛠️ **Stack:** React.js • Google Gemini AI • Web Speech API • TailwindCSS

<br>

<a href="https://github.com/ayush-3945/AI-Interview-Agent">
  <img src="https://img.shields.io/badge/Source_Code-181717?style=for-the-badge&logo=github"/>
</a>
<a href="https://interview-agent-lrak.vercel.app/">
  <img src="https://img.shields.io/badge/Live_Demo-8A2BE2?style=for-the-badge&logo=vercel&logoColor=white"/>
</a>
...
### 📊 DevPulse — GitHub Intelligence Hub
*Engineering analytics dashboard transforming commit streams into developer personality metrics.*

- ⚡ **Key Engineering:** GitHub REST API telemetry, asynchronous data aggregation, dynamic contribution heatmaps with Recharts.
- 🛠️ **Stack:** React.js • GitHub REST API • Gemini AI • Recharts

<br>

<a href="https://github.com/ayush-3945/DevPulse">
  <img src="https://img.shields.io/badge/Source_Code-181717?style=for-the-badge&logo=github"/>
</a>
<a href="https://github.com/ayush-3945/DevPulse">
  <img src="https://img.shields.io/badge/Live_Demo-8A2BE2?style=for-the-badge&logo=vercel&logoColor=white"/>
...
Whether you're looking for a **Full-Stack Engineer**, **Backend Specialist**, or **Open-Source Collaborator**, my inbox is always open.
